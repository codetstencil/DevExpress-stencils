...
using ZeraSystems.DevExpress.Grid;

namespace ZeraSystems.DevExpress.Grid
{
    /// <summary>
    ...
    {
        "ZERA Systems Inc.",                    // 0
        "Generates razor page code for DevExpress Grid",    // 1
        "This Code Nanite will generate the code for razor pages based on selections from the Global Schema.",                                  // 2
        "1.0",                                 // 3
        "DevExBlazorGrid",                         // 4
        "ZeraSystems.DevExpress.Grid",  // 5
        "12/7/2019",                          // 6
        "CS_DEVEX_BLAZOR_GRID",                     // 7
        "1",                                   // 8
        "",                                    // 9
        ""                                     // 10
    })]
    public partial class DevExBlazorGrid: ExpansionBase, ICodeStencilCodeNanite
    {
